...
class TestSearches(unittest.TestCase):
    ...
    def test_search_thingsboard_340(self):
        ...
        result, _ = search_vulns(query=query, add_other_exploit_refs=True, is_good_cpe=True, include_single_version_vulns=True)
