...
class TestSearches(unittest.TestCase):
    ...
    def test_search_libssh_general_debian_10(self):
        ...
        result,_ = search_vulns.search_vulns(query, add_other_exploit_refs=True, is_good_cpe=True)
        expected_cves = ['CVE-2023-6918','CVE-2023-1667','CVE-2020-1730','CVE-2020-16135','CVE-2019-14889','CVE-2018-10933','CVE-2016-0739','CVE-2015-3146','CVE-2014-8132','CVE-2014-0017','CVE-2013-0176','CVE-2012-6063','CVE-2012-4562','CVE-2012-4561','CVE-2012-4560','CVE-2012-4559', 'CVE-2023-48795', 'CVE-2023-6004']
        self.assertEqual(set(expected_cves), set(list(result[query]['vulns'].keys())))
