...
class TestSearches(unittest.TestCase):
    ...
    def test_search_glibc2383_debian_14(self):
        ...
        expected_cves = ['CVE-2023-6780', 'CVE-2023-6779', 'CVE-2023-6246', 'CVE-2019-9192', 'CVE-2019-1010025', 'CVE-2019-1010024', 'CVE-2019-1010023', 'CVE-2019-1010022', 'CVE-2018-20796', 'CVE-2016-20013', 'CVE-2010-4756']
        self.assertEqual(set(expected_cves), set(list(result[query]['vulns'].keys())))
