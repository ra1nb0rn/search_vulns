...
class TestSearches(unittest.TestCase):
    ...
    def test_search_vim_81_ubuntu_1404(self):
        ...
        result,_ = search_vulns.search_vulns(query, add_other_exploit_refs=True, is_good_cpe=True)
        expected_cves = ['CVE-2022-0318', 'CVE-2022-1733', 'CVE-2022-1942', 'CVE-2022-3037', 'CVE-2022-1629', 'CVE-2022-1898', 'CVE-2022-1796', 'CVE-2022-1851', 'CVE-2022-2125', 'CVE-2022-2124', 'CVE-2022-1619', 'CVE-2021-4069', 'CVE-2022-3235', 'CVE-2022-0361', 'CVE-2022-1616', 'CVE-2022-2126', 'CVE-2022-2042', 'CVE-2021-3984', 'CVE-2023-1127', 'CVE-2021-3974', 'CVE-2022-1968', 'CVE-2022-2175', 'CVE-2021-3973', 'CVE-2023-0512', 'CVE-2022-1769', 'CVE-2022-1735', 'CVE-2022-3134', 'CVE-2022-1381', 'CVE-2022-3297', 'CVE-2022-1720', 'CVE-2022-1621', 'CVE-2022-2522', 'CVE-2022-3296', 'CVE-2022-0261', 'CVE-2022-2849', 'CVE-2022-1785', 'CVE-2022-2183', 'CVE-2022-2000', 'CVE-2023-4736', 'CVE-2022-2129', 'CVE-2021-4019', 'CVE-2022-2946', 'CVE-2022-4141', 'CVE-2022-2845', 'CVE-2022-3705', 'CVE-2022-1620', 'CVE-2021-4166', 'CVE-2023-1355', 'CVE-2022-1674', 'CVE-2022-1725', 'CVE-2022-2598', 'CVE-2022-1771', 'CVE-2022-2208', 'CVE-2023-1264', 'CVE-2017-1000382']
        self.assertEqual(set(expected_cves), set(list(result[query]['vulns'].keys())))
