...
class TestSearches(unittest.TestCase):
    ...
    def test_search_libcurl_788_ubuntu_2210(self):
        self.maxDiff = None
        query = 'cpe:2.3:a:haxx:libcurl:7.88:*:*:*:*:*:*:ubuntu_22.10'
        # query = 'libcurl 7.88 ubuntu kinetic'
        result,_ = search_vulns(query, add_other_exploit_refs=True)
        expected_cves = ['CVE-2024-7264', 'CVE-2023-46219', 'CVE-2023-46218', 'CVE-2023-38545', 'CVE-2023-38546', 'CVE-2023-38039']
