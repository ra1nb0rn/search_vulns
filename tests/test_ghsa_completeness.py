...
class TestSearches(unittest.TestCase):
    ...
    def test_search_handlebars_js_300(self):
        ...
        expected_vulns = {'CVE-2021-23369': 'GHSA-f2jv-r9rf-7988', 'CVE-2019-20920': 'GHSA-3cqr-58rm-57f8', 'CVE-2021-23383': 'GHSA-765h-qjxv-5f44', 'CVE-2019-19919': 'GHSA-w457-6q6x-cgp9', 'CVE-2015-8861': 'GHSA-9prh-257w-9277', 'GHSA-g9r4-xpmj-mj65': {'published': '2020-09-04 15:06:32', 'cvss_ver': '0.0', 'cvss': '0.0', 'cvss_vec': '', 'aliases': []}, 'GHSA-q42p-pg8m-cqh6': {'published': '2019-06-05 14:07:48', 'cvss_ver': '3.1', 'cvss': '7.3', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:L', 'aliases': []}, 'GHSA-2cf5-4w76-r9qv': {'published': '2020-09-04 14:57:38', 'cvss_ver': '3.1', 'cvss': '7.3', 'cvss_vec': 'CVSS:3.1/AV:L/AC:L/PR:L/UI:R/S:C/C:L/I:H/A:L', 'aliases': []}, 'GHSA-q2c6-c6pm-g3gh': {'published': '2020-09-04 15:07:38', 'cvss_ver': '0.0', 'cvss': '0.0', 'cvss_vec': '', 'aliases': []}}
    ...
    def test_search_vmware_spring_framework_5_3_26(self):
        ...
        result = search_vulns.search_vulns(query=query, is_good_cpe=False)
        expected_vulns = {'CVE-2023-20863': 'GHSA-wxqc-pxw9-g2p8', 'CVE-2016-1000027': 'GHSA-4wrc-f8pq-fpqp', 'GHSA-2wrp-6fg6-hmc5': {'published': '2024-04-16 06:30:28', 'cvss_ver': '3.1', 'cvss': '8.1', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:N', 'aliases': ['CVE-2024-22262']}, 'GHSA-ccgv-vj62-xf9h': {'published': '2024-02-23 06:30:31', 'cvss_ver': '3.1', 'cvss': '8.1', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:N', 'aliases': ['CVE-2024-22243']}, 'GHSA-hgjh-9rj2-g67j': {'published': '2024-03-16 06:30:27', 'cvss_ver': '3.1', 'cvss': '8.1', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:N', 'aliases': ['CVE-2024-22259']}}
        expected_ghsa_vulns = [expected_vulns[vuln_id] if vuln_id.startswith('CVE') else vuln_id for vuln_id in expected_vulns]
        expected_not_matching = {}
        actual_ghsa_vulns = []
        actual_not_matching = {}
    ...
    def test_search_keycloak_23_0_7(self):
        ...
        result = search_vulns.search_vulns(query=query, is_good_cpe=False)
        expected_vulns = {'GHSA-46c8-635v-68r2': {'published': '2024-04-17 17:33:29', 'cvss_ver': '3.1', 'cvss': '5.4', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:L/I:L/A:N', 'aliases': ['CVE-2023-6544']}, 'GHSA-4vc8-pg5c-vg4x': {'published': '2024-06-12 19:41:05', 'cvss_ver': '3.1', 'cvss': '3.7', 'cvss_vec': 'CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:N/A:L', 'aliases': []}, 'GHSA-72vp-xfrc-42xm': {'published': '2024-04-17 18:25:08', 'cvss_ver': '3.1', 'cvss': '8.1', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:N', 'aliases': ['CVE-2024-1132']}, 'GHSA-8rmm-gm28-pj8q': {'published': '2024-04-17 17:33:04', 'cvss_ver': '3.1', 'cvss': '6.0', 'cvss_vec': 'CVSS:3.1/AV:N/AC:H/PR:H/UI:R/S:U/C:H/I:H/A:L', 'aliases': ['CVE-2023-6717']}, 'GHSA-4f53-xh3v-g8x4': {'published': '2024-04-17 17:31:50', 'cvss_ver': '3.1', 'cvss': '5.0', 'cvss_vec': 'CVSS:3.1/AV:N/AC:H/PR:L/UI:N/S:U/C:L/I:L/A:L', 'aliases': ['CVE-2023-3597']}, 'GHSA-7fpj-9hr8-28vh': {'published': '2024-04-17 18:25:59', 'cvss_ver': '0.0', 'cvss': '0.0', 'cvss_vec': '', 'aliases': ['CVE-2023-0657']}, 'GHSA-c9h6-v78w-52wj': {'published': '2024-04-17 18:25:29', 'cvss_ver': '3.1', 'cvss': '6.5', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:H/A:N', 'aliases': ['CVE-2023-6787']}, 'GHSA-c25h-c27q-5qpv': {'published': '2024-06-21 15:52:38', 'cvss_ver': '3.1', 'cvss': '2.7', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:H/UI:N/S:U/C:L/I:N/A:N', 'aliases': ['CVE-2024-5967']}, 'GHSA-m6q9-p373-g5q8': {'published': '2024-04-17 18:24:38', 'cvss_ver': '3.1', 'cvss': '7.4', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:C/C:N/I:N/A:H', 'aliases': ['CVE-2024-1249']}, 'GHSA-2cww-fgmg-4jqc': {'published': '2024-06-11 20:22:40', 'cvss_ver': '3.1', 'cvss': '8.1', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N', 'aliases': ['CVE-2024-3656']}, 'GHSA-3hrr-xwvg-hxvr': {'published': '2024-02-29 03:33:17', 'cvss_ver': '3.1', 'cvss': '3.7', 'cvss_vec': 'CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:N/A:L', 'aliases': ['CVE-2024-1722']}, 'GHSA-mrv8-pqfj-7gp5': {'published': '2024-04-17 17:31:12', 'cvss_ver': '3.1', 'cvss': '7.1', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:L', 'aliases': ['CVE-2024-2419']}, 'GHSA-cq42-vhv7-xr7p': {'published': '2024-06-12 19:42:21', 'cvss_ver': '3.1', 'cvss': '3.7', 'cvss_vec': 'CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:N/A:L', 'aliases': []}, 'GHSA-69fp-7c8p-crjr': {'published': '2024-06-10 18:36:56', 'cvss_ver': '3.1', 'cvss': '7.5', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N', 'aliases': ['CVE-2024-4540']}}
        expected_ghsa_vulns = [expected_vulns[vuln_id] if vuln_id.startswith('CVE') else vuln_id for vuln_id in expected_vulns]
        expected_not_matching = {'CVE-2023-0105': 'GHSA-c7xw-p58w-h6fj', 'CVE-2022-4137': 'GHSA-9hhc-pj4w-w5rv', 'CVE-2022-0225': 'GHSA-fqc7-5xxc-ph7r', 'CVE-2020-10734': 'GHSA-rvjg-gxwx-j5gf', 'CVE-2023-1664': 'GHSA-5cc8-pgp5-7mpm', 'CVE-2023-48795': 'GHSA-45x7-px36-x8w8', 'CVE-2017-12160': 'GHSA-qc72-gfvw-76h7', 'CVE-2021-3754': 'GHSA-j9xq-j329-2xvg', 'CVE-2023-2422': 'GHSA-3qh5-qqj2-c78f', 'CVE-2022-1438': 'GHSA-w354-2f3c-qvg9', 'CVE-2023-0091': 'GHSA-v436-q368-hvgg', 'CVE-2023-6927': 'GHSA-3p75-q5cc-qmj7'}
        actual_ghsa_vulns = []
        actual_not_matching = {}
    ...
    def test_search_wagtail_2_7_4(self):
        ...
        result = search_vulns.search_vulns(query=query, is_good_cpe=False)
        expected_vulns = {'CVE-2023-28836':'GHSA-5286-f2rf-35c2','CVE-2021-32681':'GHSA-xfrw-hxr5-ghqf','CVE-2021-29434':'GHSA-wq5h-f9p5-q7fx','CVE-2023-45809':'GHSA-fc75-58r8-rm3h','CVE-2023-28837':'GHSA-33pv-vcgh-jfg9','GHSA-jmp3-39vp-fwg8':{'published':'2024-07-11 13:21:42','cvss_ver':'3.1','cvss':'6.5','cvss_vec':'CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H','aliases':['CVE-2024-39317']}}
        expected_ghsa_vulns = [expected_vulns[vuln_id] if vuln_id.startswith('CVE') else vuln_id for vuln_id in expected_vulns]
        expected_not_matching = {}
        actual_ghsa_vulns = []
        actual_not_matching = {}
