...
class TestSearches(unittest.TestCase):
    ...
    def test_search_vmware_spring_framework_5_3_26(self):
        ...
        result = search_vulns.search_vulns(query=query, is_good_cpe=False)
        expected_vulns = {'CVE-2023-20863': 'GHSA-wxqc-pxw9-g2p8', 'CVE-2016-1000027': 'GHSA-4wrc-f8pq-fpqp', 'CVE-2024-22262': 'GHSA-2wrp-6fg6-hmc5', 'CVE-2024-22243': 'GHSA-ccgv-vj62-xf9h', 'CVE-2024-22259': 'GHSA-hgjh-9rj2-g67j', 'GHSA-9cmq-m9j5-mvww': {'published': '2024-08-20 09:30:28', 'cvss_ver': '3.1', 'cvss': '4.3', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:L', 'aliases': ['CVE-2024-38808']}, 'CVE-2024-38809': 'GHSA-2rmj-mq67-h97g', 'GHSA-cx7f-g6mp-7hqm': {'published': '2024-09-13 06:30:42', 'cvss_ver': '3.1', 'cvss': '7.5', 'cvss_vec': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N', 'aliases': ['CVE-2024-38816']}, 'CVE-2024-38820': 'GHSA-4gc7-5j7h-4qph', 'CVE-2024-53677': 'GHSA-43mq-6xmg-29vm', 'GHSA-q3v6-hm2v-pw99': {'published': '2024-12-02 15:31:41', 'cvss_ver': '3.1', 'cvss': '4.8', 'cvss_vec': 'CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:L/A:N', 'aliases': ['CVE-2024-38827']}, 'CVE-2024-38828': 'GHSA-w3c8-7r8f-9jp8'}
        expected_ghsa_vulns = [expected_vulns[vuln_id] if vuln_id.startswith('CVE') else vuln_id for vuln_id in expected_vulns]
        expected_not_matching = {}
        actual_ghsa_vulns = []
        actual_not_matching = {}
