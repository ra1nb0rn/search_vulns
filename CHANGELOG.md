...
* Fixed debian query preprocessing using incomplete release data
* Updated test cases
...
### Changed
- Only use two license files.

### Fixed
- Updated test cases.
- Fixed error detection, error handling and rollback in Ubuntu update module.


## v1.0.8 - 2026-03-19
### Added
- Added CC BY 4.0 license for data generated by search_vulns

### Fixed
- Actually fixed Vulncheck NVD++ rate limit problem by using its backup data.
- Updated test cases.
