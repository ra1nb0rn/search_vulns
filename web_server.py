...
def search_vulns():
    ...
    vulns = search_vulns_call(query, db_cursor=db_cursor, keep_data_in_memory=True, add_nvd_exploit_refs=True, ignore_general_cpe_vulns=ignore_general_cpe_vulns, zero_extend_versions=True, is_good_cpe=True)
